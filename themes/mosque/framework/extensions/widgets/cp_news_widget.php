<?php
class cp_recent_news_show extends WP_Widget
{
  function cp_recent_news_show()
  {
    $widget_ops = array('classname' => 'widget-holder', 'description' => 'Blog/News Post Widget' );
    parent::__construct('cp_recent_news_show', 'CrunchPress : Latest News', $widget_ops);
  }
					...
					<?php
						$counter_news = 0;		
							...
							<li>
								...
								<div class="text-box">
									<a class="title" href="<?php echo esc_url(get_permalink());?>"><?php echo substr(esc_attr(get_the_title()),0,38);?></a>
									<?php
...
add_action( 'widgets_init', create_function('', 'return register_widget("cp_recent_news_show");') );?>