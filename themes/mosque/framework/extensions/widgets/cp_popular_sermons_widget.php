...
class cp_popular_sermons extends WP_Widget
{
  ...
  {
    $widget_ops = array('classname' => 'cp_popular_sermons', 'description' => 'Select Category to show its Popular Teachings' );
    parent::__construct('cp_popular_sermons', 'CrunchPress : Show Popular Teachings', $widget_ops);
  }
